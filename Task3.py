...
for j in range(len(calls)):
    if calls[j][0].startswith("(080)") and calls[j][1].startswith("(080)"):
        counter2+=1
print("\n {} percent of calls from fixed lines in Bangalore are calls to other fixed lines in Bangalore.".format(round(counter2/counter1*100,2)))
